...
admin = 5908827749 # ID Админа
support = 5192549399 # ID сапорта
channel_id = -1001617828637 # ID Канала залётов
chat_worker_id = -1001608167632 # ID Чата с воркерами

bot_name = 'Play2x_working_bot' # Username Бота

mater = 'https://t.me/+G6GgpRBZS_FkZDVl' # Ссылка на мануалы
zalet = 'https://t.me/+3QpjHDxW9_1kMTY1' # Ссылка на канал с залётами
infos = 'https://t.me/+hbU2f2GmOW9mMjI1' # Ссылка на инфо канал
pname = 'S.Makers' # Название проекта
pdate = '09.02.2022' # Дата созданя проекта
